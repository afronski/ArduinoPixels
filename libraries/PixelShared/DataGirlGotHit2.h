...
class DataGirlGotHit2 : public PixelDataImpl<DataGirlGotHit2> { 
public:
       static int width() { return 9; }
       static int height() { return 6; }
       static const uint8_t* indices() { return _GirlGotHit2_::indices; }
       static const uint8_t* color() { return _GirlGotHit2_::color; }
};
#endif
