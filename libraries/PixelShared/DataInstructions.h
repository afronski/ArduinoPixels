...
public:
       static int width() { return 84; }
       static int height() { return 11; }
       static const uint8_t* indices() { return _Instructions_::indices; }
       static const uint8_t* color() { return _Instructions_::color; }
};
#endif
